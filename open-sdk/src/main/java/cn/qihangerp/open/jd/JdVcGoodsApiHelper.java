...
public class JdVcGoodsApiHelper {
    protected static String pullGoodsList(Integer pageStart,Integer pageSize,String appKey,String appSecret,String accessToken){
        ...
        params.put("method", "jingdong.vc.item.products.find");
        params.put("v", "2.0");
//        params.put("timestamp", DateUtil.getCurrentDateTime());
        params.put("timestamp", "2024-05-29 11:54:00");
        try {
            Map<String, Object> pmap = new TreeMap();
            pmap.put("begin_modify_time", "2024-05-28 00:00:00");
            pmap.put("end_modify_time", "2024-05-29 23:59:59");
            pmap.put("offset", pageStart);
