...
export function listCategoryAttribute(query) {
  return request({
    url: '/scm-api/goods_category/attribute_list',
    method: 'get',
    params: query
  })
}
...
export function getCategoryAttribute(id) {
  return request({
    url: '/scm-api/goods_category/attribute/' + id,
    method: 'get'
  })
}
...
export function addCategoryAttribute(data) {
  return request({
    url: '/scm-api/goods_category/attribute_add',
    method: 'post',
    data: data
  })
}
...
export function updateCategoryAttribute(data) {
  return request({
    url: '/scm-api/goods_category/attribute',
    method: 'put',
    data: data
  })
}
