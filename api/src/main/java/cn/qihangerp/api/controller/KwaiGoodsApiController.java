...
@Tag(name = "开放平台-快手小店", description = "")
@RequestMapping("/kwai/goods")
@RestController
@AllArgsConstructor
public class KwaiGoodsApiController {
    ...
    public AjaxResult pullSkuList(@Valid @RequestBody GoodsListRequest params) throws Exception {
        ...
        ApiResultVo<KwaiGoodsItem> apiResultVo = KwaiGoodsApiHelper.pullGoodsAll();
